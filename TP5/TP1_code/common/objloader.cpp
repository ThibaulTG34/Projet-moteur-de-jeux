...
bool loadOBJFile(const std::string& filename, std::vector<glm::vec3>& vertices, std::vector<unsigned short>& indices)
{
    ...
    while (std::getline(file, line)) {
        ...
        if (type == "v") {
            ...
            iss >> v1 >> v2 >> v3;
            sscanf(v1.c_str(), "%u", &i1);
            sscanf(v2.c_str(), "%u", &i2);
            sscanf(v3.c_str(), "%u", &i3);
